...
pub(crate) fn h_expr_to_sexpr(expr: &HExpr) -> String {
    match expr {
        HExpr::Get(key) => format!("(get {:?})", key),
        HExpr::Equal(lhs, rhs) => {
            format!("(equal {} {})", h_expr_to_sexpr(lhs), h_expr_to_sexpr(rhs))
        }
        HExpr::Not(inner) => format!("(not {})", h_expr_to_sexpr(inner)),
        HExpr::And(lhs, rhs) => format!("(and {} {})", h_expr_to_sexpr(lhs), h_expr_to_sexpr(rhs)),
        HExpr::Or(lhs, rhs) => format!("(or {} {})", h_expr_to_sexpr(lhs), h_expr_to_sexpr(rhs)),
        ...
        HExpr::Concat(lhs, rhs) => {
            format!("(concat {} {})", h_expr_to_sexpr(lhs), h_expr_to_sexpr(rhs))
        }
...
pub(crate) fn expr_to_sexpr(expr: &Expr) -> String {
    match expr {
        Expr::Const(value) => {
        ...
        Expr::Equal(lhs, rhs) => format!("(equal {} {})", expr_to_sexpr(lhs), expr_to_sexpr(rhs)),
        Expr::Not(inner) => format!("(not {})", expr_to_sexpr(inner)),
        Expr::And(lhs, rhs) => format!("(and {} {})", expr_to_sexpr(lhs), expr_to_sexpr(rhs)),
        Expr::Or(lhs, rhs) => format!("(or {} {})", expr_to_sexpr(lhs), expr_to_sexpr(rhs)),
        ...
        Expr::Union(lhs, rhs) => format!("(union {} {})", expr_to_sexpr(lhs), expr_to_sexpr(rhs)),
        Expr::Pipe(lhs, rhs) => format!("(pipe {} {})", expr_to_sexpr(lhs), expr_to_sexpr(rhs)),
        Expr::Concat(lhs, rhs) => format!("(concat {} {})", expr_to_sexpr(lhs), expr_to_sexpr(rhs)),
    }
}
